...
set _DeploySetParametersFile=%RootPath%Minor.ServiceBus.PfSLocatorService.Host.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%Minor.ServiceBus.PfSLocatorService.Host.zip" (
echo "%RootPath%Minor.ServiceBus.PfSLocatorService.Host.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Minor.ServiceBus.PfSLocatorService.Host.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Minor.ServiceBus.PfSLocatorService.Host.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%Minor.ServiceBus.PfSLocatorService.Host.deploy-readme.txt" (
...
start notepad "%RootPath%Minor.ServiceBus.PfSLocatorService.Host.deploy-readme.txt"
)
echo =========================================================
goto :eof
